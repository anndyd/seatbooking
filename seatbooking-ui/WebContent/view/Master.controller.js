...
sap.ui.define([
		...
		"sap/ui/Device",
		"sap/ui/bk/masterdetail/model/formatter",
		"sap/ui/bk/masterdetail/model/grouper",
		"sap/ui/bk/masterdetail/model/GroupSortState"
	], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, grouper, GroupSortState) {
		"use strict";

		return BaseController.extend("sap.ui.bk.masterdetail.view.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("sap.ui.bk.masterdetail.view.fragment.ViewSettingsDialog", this);
